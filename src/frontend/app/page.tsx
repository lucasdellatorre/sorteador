      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          <p className={`${inter.className} text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            ...
            <strong>Bem-vindo a Tigre-Sena</strong>. Lugar onde seus sonhos viram realiadade.{' '} <br></br>
            Vamos começar a <strong className={`text-xl text-red-500 md:text-3xl md:leading-normal`}> apostar </strong>?
          </p>
          <Link
            href="/home"
